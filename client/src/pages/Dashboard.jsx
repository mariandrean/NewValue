                ...
                <div class="container px-5 py-24 mx-auto">
                    <div class="-my-8 divide-y-2 divide-gray-100">
                        ...
                        <div className="flex flex-col lg:flex-row justify-between items-center mb-4">
                            ...
                            <button type="button" onClick={() => navigate('/dashboard/create')} className="bg-teal-500 text-white border-green-900 rounded-lg font-semibold py-2 px-4 hover:bg-teal-800 transition duration-300 ease-in-outmt-4 lg:mt-0">
                                Nueva Noticia
                            </button>
                            {user && userRole === 'admin' && (
                                <div>
