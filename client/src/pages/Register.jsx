        ...
        <form className="min-w-[300px] gap-6 flex flex-col justify-center" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex">
            <div className="relative w-full">
              ...
              <input
                className="mt-6 input border border-gray-400 appearance-none rounded w-full p-3 focus focus:border-teal-500 focus:outline-none active:outline-none active:border-teal-500"
              ...
              <button
                ...
                className="absolute text-sm mt-9 right-3 text-gray-500"
